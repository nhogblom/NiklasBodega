            ...
            <div className="flex-1 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 bg-white rounded-2xl p-10 w-full max-w-md shadow-2xl border border-stone-100">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-serif text-stone-800 mb-1">Welcome back</h1>
                        <p className="text-sm text-stone-500">Sign in to manage your reservations</p>
                    </div>
                    ...
                    <div className="mb-2">
                        ...
                        <div className="text-right mt-1">
                            <a href="#" className="text-xs text-orange-700 hover:text-orange-900">
                                Forgot password?
                            </a>
                        </div>
                    </div>
