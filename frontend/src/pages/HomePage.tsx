...
const BookingInput = ({ label, value }: { label: string; value: string }) => (
    <div className="flex-1 text-left min-w-[150px]">
        <label className="block text-[10px] uppercase font-bold text-stone-500 mb-1 ml-1">{label}</label>
        <input
            type="text"
            defaultValue={value}
    ...
    <header className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
            ...
            <div className="bg-white p-5 rounded-xl shadow-2xl flex flex-wrap md:flex-nowrap gap-4 items-end max-w-5xl mx-auto text-stone-800">
                ...
                <div className="flex-1 text-left min-w-[150px]">
                    <label className="block text-[10px] uppercase font-bold text-stone-500 mb-1 ml-1">Guests</label>
...
const RoomCard = ({ title, price, image }: { title: string; price: number; image: string }) => (
...
const Homepage: React.FC = () => {
    const rooms = [
        { title: "The Garden Suite", price: 320, image: "https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&q=80&w=800" },
        { title: "The Bodega Loft", price: 450, image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&q=80&w=800" },
        { title: "Signature Terrace", price: 680, image: "https://images.unsplash.com/photo-1578683010236-d716f9a3f461?auto=format&fit=crop&q=80&w=800" },
    ];
        ...
        <div className="min-h-screen bg-stone-50 selection:bg-orange-100 selection:text-orange-900">
            ...
            <section className="py-24 px-8 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16">
                    <div>
                        <span className="text-orange-700 font-bold tracking-[0.2em] text-xs uppercase">The Sanctuary</span>
                        <h2 className="text-4xl md:text-5xl font-serif mt-4">Curated Guest Suites</h2>
                    </div>
            ...
            <footer className="bg-stone-950 text-stone-500 py-16 px-8">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h4 className="text-white text-2xl font-serif font-bold mb-4">Niklas Bodega</h4>
                        <p className="text-sm max-w-sm">
                            An exclusive escape designed for those who appreciate the finer notes of life.
                        </p>
                    </div>
